...
//=======================================================================
#include "avl.h"    //      INCLUDE 'AVL.INC'
#include "avlplt.h" //      INCLUDE 'AVLPLT.INC'
char error;         //      LOGICAL ERROR
//
char comand[4];     //      CHARACTER*4 COMAND
char comarg[128];   //      CHARACTER*128 COMARG
char fnnew[80];     //      CHARACTER*80 FNNEW
//
double rinput[20];  //      REAL    RINPUT(20)
long   iinput[20];  //      INTEGER IINPUT(20)
//
//      
char version[] = "4.0"; //      VERSION = 3.31
//
void format(char  1000 FORMAT(A)
//
      WRITE (*,1005) VERSION
 1005 FORMAT (
     &  /' ==================================================='
