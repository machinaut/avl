// fuck it i'll convert the rest later -ajr
package main //avl
...
// unit values, names, and namelengths
      ...
      string UNCHL,UNCHM,UNCHT,UNCHF,UNCHS,UNCHV,UNCHA,UNCHI,UNCHD
...
//
      REAL MACH, MACH0
//
      string FILDEF, FRNDEF, FMSDEF, FPRDEF, FEVDEF
      string TITLE
      string STITLE, BTITLE, RTITLE
      string DNAME, GNAME
      string VARNAM, CONNAM
      string VARKEY
      string CONKEY
      string PARNAM
      string PARUNCH
